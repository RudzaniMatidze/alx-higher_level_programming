#!/usr/bin/python3
"""Defines unittests for base.py file.
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests for testing the save_to_file method of Base class."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unittests for testing the save_to_file_csv method of Base class."""
